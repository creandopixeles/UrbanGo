                        ...
                        <form id="unidadForm" novalidate>
                            <div class="row mb-3 mt-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="anden" name="anden" class="form-control form-control-sm" required>
                                    <div class="invalid-feedback">El andén es obligatorio.</div>
                                </div>
                                <div class="col-md-12">
                                    <label for="status" class="form-label">Status:</label>
                                    <input type="text" id="status" name="status" class="form-control form-control-sm" required>
                                    <div class="invalid-feedback">La status es obligatoria.</div>
                                </div>
                            </div>
